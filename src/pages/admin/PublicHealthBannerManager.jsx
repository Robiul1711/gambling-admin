...
export default function PublicHealthBannerManager() {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      await axiosSecure.put("/about/public-health-banner", formData, {
        headers: { "Content-Type": "multipart/form-data" },
      });
      toast.success("Public Health Page Banner updated successfully!");
      setImageFile(null);
      refetch();
    } catch (err) {
    ...
    <div className="space-y-6">
      ...
      <div className="bg-gradient-to-r from-[#0F4A63] to-[#156E94] rounded-2xl px-7 py-5 text-white shadow-sm">
        ...
        <p className="text-white/70 text-sm mt-1">
          Manage the hero banner details, subtitle, description, and cover diagram/image for the Public health organisations page.
        </p>
      </div>
        ...
        <div className="p-8 space-y-6">
          ...
          <div className="flex flex-col gap-1.5">
            ...
            <input
              ...
              placeholder="For stakeholders · Public health organisations"
          ...
          <div className="flex flex-col gap-1.5">
            ...
            <input
              ...
              placeholder="A modifiable risk factor that hasn't been treated like one."
              className="px-4 py-2.5 rounded-xl border border-slate-200 focus:border-[#156E94] outline-none text-sm transition-all duration-200 text-slate-700 bg-white"
            />
          </div>
          ...
          <div className="flex flex-col sm:flex-row items-center gap-5 bg-slate-50 p-4 rounded-2xl border border-slate-200/60">
            ...
            <div className="space-y-2 text-center sm:text-left">
              <h4 className="text-sm font-bold text-slate-800">Banner Diagram/Image</h4>
