...
export default function OurWorkBurdenBannerManager() {
  ...
  useEffect(() => {
    if (responseData?.data) {
      ...
      setForm({
        title: d.title || "Gambling is a leading, modifiable risk factor for ill-health in the UK, and is treated as if it isn't.",
        subtitle: d.subtitle || "Evidence · Burden of harm",
        description: d.description || "This page sets out the population burden, the people who carry it, and why the UK's policy response to gambling harm is several orders of magnitude smaller than the public-health evidence justifies.",
      });
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      await axiosSecure.put("/about/work-burden-banner", formData, {
        headers: { "Content-Type": "multipart/form-data" },
      });
      toast.success("Burden of Harm Banner updated successfully!");
      setImageFile(null);
      refetch();
    } catch (err) {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-gradient-to-r from-[#0F4A63] to-[#156E94] rounded-2xl px-7 py-5 text-white shadow-sm">
        <h1 className="text-xl font-bold tracking-tight">Burden of Harm Page CMS</h1>
        <p className="text-white/70 text-sm mt-1">
          Manage the hero banner details, tagline, description, and cover image for the Burden of Harm page.
        </p>
      </div>
        ...
        <div className="p-8 space-y-6">
          ...
          <div className="flex flex-col gap-1.5">
            ...
            <input
              ...
              placeholder="Evidence · Burden of harm"
          ...
          <div className="flex flex-col gap-1.5">
            ...
            <input
              ...
              placeholder="Gambling is a leading, modifiable risk factor..."
              className="px-4 py-2.5 rounded-xl border border-slate-200 focus:border-[#156E94] outline-none text-sm transition-all duration-200 text-slate-700 bg-white"
            />
          </div>
