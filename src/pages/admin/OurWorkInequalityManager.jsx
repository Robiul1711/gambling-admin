...
export default function OurWorkInequalityManager() {
  ...
  useEffect(() => {
    if (responseData?.data) {
      ...
      setForm({
        title: d.title || "Gambling harm is not evenly distributed.",
        subtitle: d.subtitle || "Our work · Inequality",
        description: d.description || "Anyone can be harmed by gambling. But the harm tracks the same gradients that every other commercial-determinant harm does, deprivation, ethnicity, gender, neurodivergence, age, intersecting marginalisation. This page sets out how, and why.",
      });
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      await axiosSecure.put("/about/work-inequality-banner", formData, {
        headers: { "Content-Type": "multipart/form-data" },
      });
      toast.success("Inequality Banner updated successfully!");
      setImageFile(null);
      refetch();
    } catch (err) {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-gradient-to-r from-[#0F4A63] to-[#156E94] rounded-2xl px-7 py-5 text-white shadow-sm">
        <h1 className="text-xl font-bold tracking-tight">Inequality Page CMS</h1>
        <p className="text-white/70 text-sm mt-1">
          Manage the hero banner details, tagline, description, and cover image for the Inequality page.
        </p>
      </div>
        ...
        <div className="p-8 space-y-6">
          ...
          <div className="flex flex-col gap-1.5">
            ...
            <input
              ...
              placeholder="Our work · Inequality"
          ...
          <div className="flex flex-col gap-1.5">
            ...
            <input
              ...
              placeholder="Gambling harm is not evenly distributed."
              className="px-4 py-2.5 rounded-xl border border-slate-200 focus:border-[#156E94] outline-none text-sm transition-all duration-200 text-slate-700 bg-white"
            />
          </div>
