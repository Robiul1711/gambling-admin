...
export default function ProfessionalsManager() {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      await axiosSecure.put("/about/stakeholder", formData, {
        headers: { "Content-Type": "multipart/form-data" },
      });
      toast.success("Stakeholders section banner updated successfully!");
      setImageFile(null);
      refetch();
    } catch (err) {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-gradient-to-r from-[#0F4A63] to-[#156E94] rounded-2xl px-7 py-5 text-white shadow-sm">
        <h1 className="text-xl font-bold tracking-tight">Professionals Page CMS</h1>
        <p className="text-white/70 text-sm mt-1">
          Manage banner details, cover illustration, and text shown under the Stakeholders Section of the Professionals page.
        </p>
      </div>
        ...
        <div className="p-8 space-y-6">
          ...
          <div className="flex flex-col gap-1.5">
            ...
            <input
              ...
              placeholder="We work with everyone the public-health response touches."
              className="px-4 py-2.5 rounded-xl border border-slate-200 focus:border-[#156E94] outline-none text-sm transition-all duration-200 text-slate-700 bg-white"
            />
          </div>
