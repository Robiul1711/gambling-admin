...
export default function CYPBannerManager() {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      await axiosSecure.put("/about/cyp-banner", formData, {
        headers: { "Content-Type": "multipart/form-data" },
      });
      toast.success("CYP Banner updated successfully!");
      setImageFile(null);
      refetch();
    } catch (err) {
    ...
    <div className="space-y-6">
      ...
      <div className="bg-gradient-to-r from-[#0F4A63] to-[#156E94] rounded-2xl px-7 py-5 text-white shadow-sm">
        ...
        <p className="text-white/70 text-sm mt-1">
          Manage the hero banner details, subtitle, description, and cover image for the Children & Young People page.
        </p>
      </div>
        ...
        <div className="p-8 space-y-6">
          ...
          <div className="flex flex-col gap-1.5">
            ...
            <input
              ...
              placeholder="For stakeholders · Children & young people"
          ...
          <div className="flex flex-col gap-1.5">
            ...
            <input
              ...
              placeholder="Gambling harm reaches further into childhood than the public conversation acknowledges."
              className="px-4 py-2.5 rounded-xl border border-slate-200 focus:border-[#156E94] outline-none text-sm transition-all duration-200 text-slate-700 bg-white"
            />
          </div>
