...
export default function GetHelpOverviewManager() {
  ...
  useEffect(() => {
    if (responseData?.data) {
      ...
      setForm({
        title: d.title || "There's a way through this. Here's where to start.",
        subtitle: d.subtitle || "Support that works",
        description: d.description || "Whatever stage you're at (confused, scared, ready to change, recovering, or relapsing) there is a route to support that fits. You don't have to have hit 'rock bottom' to deserve it. And you don't have to do this on willpower alone.",
      });
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      await axiosSecure.put("/about/get-help-overview", formData, {
        headers: { "Content-Type": "multipart/form-data" },
      });
      toast.success("Get Help Overview Banner updated successfully!");
      setImageFile(null);
      refetch();
    } catch (err) {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-gradient-to-r from-[#0F4A63] to-[#156E94] rounded-2xl px-7 py-5 text-white shadow-sm">
        <h1 className="text-xl font-bold tracking-tight">Get Help Overview Page CMS</h1>
        <p className="text-white/70 text-sm mt-1">
          Manage the hero banner details, tagline, description, and cover image for the Get Help Overview page.
        </p>
      </div>
        ...
        <div className="p-8 space-y-6">
          ...
          <div className="flex flex-col gap-1.5">
            ...
            <input
              ...
              placeholder="Support that works"
          ...
          <div className="flex flex-col gap-1.5">
            ...
            <input
              ...
              placeholder="There's a way through this. Here's where to start."
              className="px-4 py-2.5 rounded-xl border border-slate-200 focus:border-[#156E94] outline-none text-sm transition-all duration-200 text-slate-700 bg-white"
            />
          </div>
