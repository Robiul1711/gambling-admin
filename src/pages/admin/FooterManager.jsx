...
const FooterManager = () => {
  ...
  const onSubmit = (formData) => {
    ...
    // Preserve existing crisis header fields
    payload.append(
      "crisisHeaderShow",
    ...
    payload.append("crisisHeaderText", footerData?.crisisHeaderText || "");
    payload.append("crisisHeaderPhone", footerData?.crisisHeaderPhone || "");
    payload.append(
      "crisisHeaderPhoneLink",
    ...
    payload.append(
      "crisisHeaderBtnLink",
      footerData?.crisisHeaderBtnLink || "",
    );
    payload.append(
      "crisisHeaderBgColor",
      footerData?.crisisHeaderBgColor || "#C92525",
    );
    payload.append(
      "crisisHeaderTextColor",
      footerData?.crisisHeaderTextColor || "#ffffff",
    );
