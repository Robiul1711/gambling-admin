...
export default function OurWorkTacticsManager() {
  ...
  useEffect(() => {
    if (responseData?.data) {
      ...
      setForm({
        title: d.title || "Gambling Tactics.",
        subtitle: d.subtitle || "Our work · Gambling Tactics",
        description: d.description || "A first-of-its-kind repository of evidence on the gambling industry's strategies and tactics for undermining public health. Inspired by Tobacco Tactics. Industry interference is the single greatest barrier to progress in reducing UK gambling harm. The tactics below are how that interference operates.",
      });
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      await axiosSecure.put("/about/work-tactics-banner", formData, {
        headers: { "Content-Type": "multipart/form-data" },
      });
      toast.success("Gambling Tactics Banner updated successfully!");
      setImageFile(null);
      refetch();
    } catch (err) {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-gradient-to-r from-[#0F4A63] to-[#156E94] rounded-2xl px-7 py-5 text-white shadow-sm">
        <h1 className="text-xl font-bold tracking-tight">Gambling Tactics Page CMS</h1>
        <p className="text-white/70 text-sm mt-1">
          Manage the hero banner details, tagline, description, and cover collage image for the Gambling Tactics page.
        </p>
      </div>
        ...
        <div className="p-8 space-y-6">
          ...
          <div className="flex flex-col gap-1.5">
            ...
            <input
              ...
              placeholder="Our work · Gambling Tactics"
