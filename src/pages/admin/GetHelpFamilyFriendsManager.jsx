...
export default function GetHelpFamilyFriendsManager() {
  ...
  useEffect(() => {
    if (responseData?.data) {
      ...
      setForm({
        title: d.title || "The harm reaching you is real. You didn't choose it, and you don't have to carry it alone.",
        subtitle: d.subtitle || "For family & friends",
        description: d.description || "If someone you love is being harmed by gambling, you are being harmed too. Partners, parents, children, siblings, close friends. The impact is real, large, and almost certainly worse than you've been told. There is support that belongs to you, by right.",
      });
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      await axiosSecure.put("/about/get-help-family-friends", formData, {
        headers: { "Content-Type": "multipart/form-data" },
      });
      toast.success("Get Help Family & Friends Banner updated successfully!");
      setImageFile(null);
      refetch();
    } catch (err) {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-gradient-to-r from-[#0F4A63] to-[#156E94] rounded-2xl px-7 py-5 text-white shadow-sm">
        <h1 className="text-xl font-bold tracking-tight">For Family & Friends Page CMS</h1>
        <p className="text-white/70 text-sm mt-1">
          Manage the hero banner details, tagline, description, and cover image for the For Family & Friends page.
        </p>
      </div>
        ...
        <div className="p-8 space-y-6">
          ...
          <div className="flex flex-col gap-1.5">
            ...
            <input
              ...
              placeholder="For family & friends"
          ...
          <div className="flex flex-col gap-1.5">
            ...
            <input
              ...
              placeholder="The harm reaching you is real. You didn't choose it, and you don't have to carry it alone."
              className="px-4 py-2.5 rounded-xl border border-slate-200 focus:border-[#156E94] outline-none text-sm transition-all duration-200 text-slate-700 bg-white"
            />
          </div>
